...
extensions = ['sphinx.ext.coverage', 'sphinx.ext.mathjax']
...
mathjax_path = 'https://c328740.ssl.cf1.rackcdn.com/mathjax/latest/MathJax.js?config=TeX-AMS-MML_HTMLorMML%22%3E'
